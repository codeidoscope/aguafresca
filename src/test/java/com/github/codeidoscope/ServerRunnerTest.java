...
class ServerRunnerTest {
    ...
    void testGetValidResourceReturnsCorrectResponse() throws IOException {
        ...
        mockServerRouter.addRoute("/valid", new Response(new Header("HTTP/1.1 200 OK".getBytes()), new Body("Hello World".getBytes())));
    ...
    void testGetInvalidResourceReturnsCorrectResponse() throws IOException {
        MockRouter mockServerRouter = new MockRouter();
        mockServerRouter.addRoute("/", new Response(new Header("HTTP/1.1 404 Not Found".getBytes()), new Body("404 Not Found".getBytes())));
