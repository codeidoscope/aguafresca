...
//        Response expectedResponse = new Response(headers, new Body("Test file."), "text/plain");
//
...
//        Response expectedResponse = new Response(headers, new Body("404 - NOT FOUND"), "text/plain");
//
//        assertFalse(serverRouter.route(request).getHeadersToString().isEmpty());
//        assertEquals(expectedResponse.getBodyToString(), serverRouter.route(request).getBodyToString());
//    }
...
//        Response expectedResponse = new Response(header, new Body(form), "text/html");
//
//        assertFalse(serverRouter.route(request).getHeadersToString().isEmpty());
//        assertEquals(expectedResponse.getBodyToString(), serverRouter.route(request).getBodyToString());
//    }
